     ...
     public class BrowserDelegate : BaseUIDelegate, IBrowser
     {
          ...
          */
          public bool OpenExtenalBrowser(string url) {
               ...
               throw new NotSupportedException("BrowserDelegate:openExtenalBrowser");
               // return response;
          }
          ...
          */
          public bool OpenInternalBrowser(string url, string title, string backButtonText) {
               // bool response;
               // TODO: Not implemented.
               throw new NotSupportedException("BrowserDelegate:openInternalBrowser");
               // return response;
          }
          ...
          */
          public bool OpenInternalBrowserModal(string url, string title, string backButtonText) {
               // bool response;
               // TODO: Not implemented.
               throw new NotSupportedException("BrowserDelegate:openInternalBrowserModal");
               // return response;
          }
