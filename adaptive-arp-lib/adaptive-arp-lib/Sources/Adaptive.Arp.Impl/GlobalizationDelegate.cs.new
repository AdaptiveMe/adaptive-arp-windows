     ...
     public class GlobalizationDelegate : BaseApplicationDelegate, IGlobalization
     {
          ...
          */
          public Locale GetDefaultLocale() {
               ...
               throw new NotSupportedException("GlobalizationDelegate:getDefaultLocale");
               // return response;
          }
          ...
          */
          public Locale[] GetLocaleSupportedDescriptors() {
               // Locale[] response;
               // TODO: Not implemented.
               throw new NotSupportedException("GlobalizationDelegate:getLocaleSupportedDescriptors");
               // return response;
          }
          ...
          */
          public string GetResourceLiteral(string key, Locale locale) {
               // string response;
               // TODO: Not implemented.
               throw new NotSupportedException("GlobalizationDelegate:getResourceLiteral");
               // return response;
          }
          ...
          */
          public KeyPair[] GetResourceLiterals(Locale locale) {
               // KeyPair[] response;
               // TODO: Not implemented.
               throw new NotSupportedException("GlobalizationDelegate:getResourceLiterals");
               // return response;
          }
