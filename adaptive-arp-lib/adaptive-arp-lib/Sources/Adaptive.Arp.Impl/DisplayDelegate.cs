     ...
     public class DisplayDelegate : BaseSystemDelegate, IDisplay
     {
          ...
          */
          public void AddDisplayOrientationListener(IDisplayOrientationListener listener) {
               ...
               throw new NotSupportedException("DisplayDelegate:addDisplayOrientationListener");
          }
...
of the device. For device orientation, use the IDevice APIs.
          ...
          */
          public ICapabilitiesOrientation GetOrientationCurrent() {
               ...
               // TODO: Not implemented.
               throw new NotSupportedException("DisplayDelegate:getOrientationCurrent");
               // return response;
          }
          ...
          */
          public void RemoveDisplayOrientationListener(IDisplayOrientationListener listener) {
               // TODO: Not implemented.
               throw new NotSupportedException("DisplayDelegate:removeDisplayOrientationListener");
          }
          ...
          */
          public void RemoveDisplayOrientationListeners() {
               // TODO: Not implemented.
               throw new NotSupportedException("DisplayDelegate:removeDisplayOrientationListeners");
          }
