...
Appverse = {
    ...
    init: function() {
        ...
        if (typeof(this.is.Emulator) != "undefined" && this.is.Emulator == true) {
            ...
            AppverseEmulator.eventListenersRegistered["DetectQRCode"] = Appverse.Media.onQRCodeDetected;
...
Appverse.SERVICE_URI = 'http://192.168.1.51:' + LOCAL_SERVER_PORT + Appverse.SERVICE_URI;
Appverse.SERVICE_ASYNC_URI = 'http://192.168.1.51:' + LOCAL_SERVER_PORT + Appverse.SERVICE_ASYNC_URI;
Appverse.REMOTE_RESOURCE_URI = 'http://192.168.1.51:' + LOCAL_SERVER_PORT + Appverse.REMOTE_RESOURCE_URI;
Appverse.DOCUMENTS_RESOURCE_URI = 'http://192.168.1.51:' + LOCAL_SERVER_PORT + Appverse.DOCUMENTS_RESOURCE_URI;
Appverse.MODULES_RESOURCE_URI = 'http://192.168.1.51:' + LOCAL_SERVER_PORT + Appverse.MODULES_RESOURCE_URI;
...
Beacon = function() {
     ...
     * @returns {undefined}
     */
    this.OnEntered = function(beacon) {
    };
     ...
     * @returns {undefined}
     */
    this.OnDiscover = function(beacon) {
    };
    /**
     * 
     * @param {type} Beacon
 ...
 * @type type
 */
Beacon.prototype.StartMonitoringAllRegions = function(id)
{
...
Beacon.prototype.StopMonitoringBeacons = function() {
    return post_to_url(Appverse.Beacon.serviceName, "StopMonitoringBeacons", null, "POST");
};
